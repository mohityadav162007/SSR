...
const WhatsAppButton = () => {
  ...
  const whatsappNumber = "916260001228";
  const message = "Hello! I would like to get a quote for logistics services.";
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <a
        ...
        className="flex items-center justify-center w-16 h-16 bg-[#25D366] rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 animate-pulse-glow group"
